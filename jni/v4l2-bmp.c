...
JNIEXPORT jint JNICALL Java_com_wx_CamChange_JniCamera_camSel(JNIEnv* env,
										 jobject thiz)
{
	jint ret = 0;
...
JNIEXPORT jint JNICALL Java_com_wx_CamChange_JniCamera_setMode(JNIEnv* env,
...
JNIEXPORT jint JNICALL Java_com_wx_CamChange_JniCamera_prepareBuffer(JNIEnv* env,
		 jobject thiz)
{
	jint ret = 0;
    int i;
...
JNIEXPORT jint JNICALL Java_com_wx_CamChange_JniCamera_takePicture(JNIEnv* env,
										 jobject thiz)
{
    int i,j;
    jint ret = 0;
